                <footer class="footer">
                  <div class="footer__container _container">
                        <div class="row">
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-2 col-min">
                                <? showfootmenu(1,$_SESSION[language]); ?>
                            </div>
                            <div class="col-xl-2 col-lg-2 col-md-2 col-min">
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-2 col-min">
                                <p class="footer__community-name home__community-name">
                                    <?=$arrLang['audited']?>:<br><br>
                                    <img src="/public/img/defimoon.png">
                                </p>
                            </div>
                        </div>
                  </div>
    ...
    <script>
        function copywallet(wallet) {
            var $temp = $("<input>");
            $("body").append($temp);
            $temp.val(wallet).select();
            document.execCommand("copy");
            $temp.remove();
        }
        
        document.getElementById('usermenus').addEventListener('click', function () {
            document.getElementById('usermenu').style.display = 'block';
        })
        document.getElementById('usermenuc').addEventListener('click', function () {
